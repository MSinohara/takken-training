const GAS_WEB_APP_URL =
  ...
  location.hostname === "takken10b-checkin.web.app" ||
  location.hostname === "takken10b-checkin.firebaseapp.com"
...
function shouldRetryJsonp_(action, retryCount){
  ...
  const maxRetries =
    String(action || "") === "getMailPreviewJsonp"
      ? 3
      : 1;
